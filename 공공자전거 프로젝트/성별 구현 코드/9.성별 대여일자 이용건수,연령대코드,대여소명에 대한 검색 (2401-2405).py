...
# '이동거리' 열이 존재하는지 확인 =>merged한 항목에 이동거리가 없으면 에러가 발생이 된다.
...
성별에 따라 가장 자주 이용한 자치구 및 대여소:
     성별  자치구               대여소명    이용건수
1349  F  마포구   4217. 한강공원 망원나들목   96795
3190  M  강서구  2715.마곡나루역 2번 출구   141590

가장 많이 이용한 대여소명:
대여소명: 2715.마곡나루역 2번 출구 , 이용건수: 231,700

가장 적게 이용한 대여소명:
대여소명: AS센터, 이용건수: 9

평균적으로 이용한 대여소명:
대여소명: 4110. 용두롯데캐슬리치아파트 앞, 이용건수: 21,115
'''
