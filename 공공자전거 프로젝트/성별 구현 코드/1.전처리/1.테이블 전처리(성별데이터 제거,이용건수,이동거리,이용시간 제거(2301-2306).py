...
#bicycle_selected = bicycle_selected.drop_duplicates() 이 프로젝트에서는 중복된 데이터가 있을 수 있기때문에 삭제시키면 안된다.
...
# output_path = './select/서울특별시 공공자전거 이용정보(시간대별)_2301-2306.csv'
...
memory usage: 1.1+ GB
None
중복된 데이터가 250개 발견되었습니다.
처리된 데이터 정보:
<class 'pandas.core.frame.DataFrame'>
Index: 12977566 entries, 0 to 12977815
...
memory usage: 1.1+ GB
None
선택된 데이터가 ./select/서울특별시 공공자전거 이용정보(시간대별)_2301-2306.csv 파일에 저장되었습니다.
'''
